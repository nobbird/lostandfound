...
<body>
<a href="issuelost.jsp">发布招领启事信息</a>
...
<tr>
    <td colspan="7" align="center">
        <a href="goodsinfo.jsp">首页</a>
        <a href="goodsinfo.jsp?strpage=<%=pageNum-1%>">上一页</a>
        <a href="goodsinfo.jsp?strpage=<%=pageNum+1%>">下一页</a>
        <a href="goodsinfo.jsp?strpage=<%=wupingDao.LastPage(5,1) %>">末页</a>
        <form action="goodsinfo.jsp" method="get">
