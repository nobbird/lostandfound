...
<%
    ...
    for(int i=0;i<myCookie.length;i++){
        ...
        if(newCookie.getName().equals("uname")){
            uname=newCookie.getValue();
        }
        if(newCookie.getName().equals("upass")){
            upass=newCookie.getValue();
        }
    }
%>
<!DOCTYPE html>
    ...
    <div class="content">
        ...
        <div class="login_box">
            ...
            <div class="login_form">
                ...
                <form id="form-login" action="do2.jsp" method="post">
                    ...
                    <div class="form_reg_btn">
                        <span>还没有帐号？</span><a href="index.jsp">马上注册</a>
                    </div>
                    <br>
                </form>
            </div>
